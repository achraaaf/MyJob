...
import 'package:flutter_application_1/job_seeker_views/Widgets/application/controllers/ApplyWithCVcontroller.dart';
...
class ApplyWithCVview extends StatelessWidget {
  ...
  ApplyWithCVview({required this.jobPost, Key? key}) : super(key: key);
                ...
                return Column(
                  ...
                  children: [
                    ...
                    TextField(controller.emailController,
                        validator: (Value) =>
                            Validation.ValidateEmail(Value, false)),
                    SizedBox(height: 13),
                    Text(
                      'Upload CV/Resume',
                      style: GoogleFonts.dmSans(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            controller.submit(jobPost, context, formKey);
                          },
