...
class ChatPage extends StatefulWidget {
  ...
  ChatPage({super.key, required this.conversation, required this.JobSeeker});
...
class _ChatPageState extends State<ChatPage> {
    ...
    _messageSubscription = FirebaseFirestore.instance
      ...
      for (var docChange in snapshot.docChanges) {
        if (docChange.type == DocumentChangeType.added) {
          ...
          if (senderId == widget.JobSeeker.id && !isRead) {
  ...
  Widget build(BuildContext context) {
    final controller = EmployerMessagesController.instance;
  ...
  Widget _buildMessageList(EmployerMessagesController controller) {
